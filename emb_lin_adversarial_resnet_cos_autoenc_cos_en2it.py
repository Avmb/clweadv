...
MODEL_FILENAME = 'emb_lin_adversarial_resnet_cos_autoenc_cos_3_en2it.pkl'
...
def load_model():
	params = lasagne.layers.get_all_params([discriminator_0.l_out, discriminator_1.l_out, gen_l_out])
