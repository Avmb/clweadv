...
MODEL_FILENAME = 'emb_multi_adversarial_resnet_cos_autoenc_cos_3_en2it.pkl'
...
class Generator(object):
	def __init__(self, embedding_dim=100, num_hidden_layers=2, hidden_dim=200, latent_dim=10, min_std=1e-4, prior_std=0.1, rng=None, update_hyperparams={'learning_rate': 0.01}):
		...
		self.encoder_layers = [self.gen_l_enc_in]
