...
MODEL_FILENAME = 'emb_lin_adversarial_cos_autoenc_cos_en2de.pkl'
...
discriminator_0 = Discriminator(d, DISCR_NUM_HIDDEN_LAYERS, DISCR_NUM_HIDDEN_LAYERS, in_dropout_p=0.0, hidden_dropout_p=0.0, update_hyperparams={'learning_rate': 0.001})
discriminator_1 = Discriminator(d, DISCR_NUM_HIDDEN_LAYERS, DISCR_NUM_HIDDEN_LAYERS, in_dropout_p=0.0, hidden_dropout_p=0.0, update_hyperparams={'learning_rate': 0.001})
