...
MODEL_FILENAME = 'emb_multinonlin_adversarial_resnet_cos_autoenc_cos_en2it.pkl'
...
gen_l_hid1 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(gen_l_in_dr, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.GlorotUniform(gain='relu'), name='gen_l_hid1'))
gen_l_hid1_dr = lasagne.layers.DropoutLayer(gen_l_hid1, 0.5)
gen_l_hid2 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(gen_l_hid1_dr, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.GlorotUniform(gain='relu'), name='gen_l_hid2'))
gen_l_hid2_dr = lasagne.layers.DropoutLayer(gen_l_hid2, 0.5)
gen_l_hid3 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(gen_l_hid2_dr, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.GlorotUniform(gain='relu'), name='gen_l_hid3'))
gen_l_hid3_dr = lasagne.layers.DropoutLayer(gen_l_hid3, 0.5)
gen_l_out = lasagne.layers.DenseLayer(gen_l_hid3_dr, num_units=d, nonlinearity=None, W=lasagne.init.GlorotUniform(), name='gen_l_out')
...
dec_l_hid1 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(gen_l_out, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.Orthogonal(gain='relu'), name='dec_l_hid1'))
dec_l_hid2 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(dec_l_hid1, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.Orthogonal(gain='relu'), name='dec_l_hid2'))
dec_l_hid3 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(dec_l_hid2, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.Orthogonal(gain='relu'), name='dec_l_hid3'))
dec_l_out = lasagne.layers.DenseLayer(dec_l_hid3, num_units=d, nonlinearity=None, W=lasagne.init.Orthogonal(), name='dec_l_out')
...
gen_1_l_in_dr = lasagne.layers.DropoutLayer(gen_1_l_in, 0.2)
gen_1_l_hid1 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(gen_1_l_in_dr, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.GlorotUniform(gain='relu'), name='gen_1_l_hid1'))
gen_1_l_hid1_dr = lasagne.layers.DropoutLayer(gen_1_l_hid1, 0.5)
gen_1_l_hid2 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(gen_1_l_hid1_dr, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.GlorotUniform(gain='relu'), name='gen_1_l_hid2'))
gen_1_l_hid2_dr = lasagne.layers.DropoutLayer(gen_1_l_hid2, 0.5)
gen_1_l_hid3 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(gen_1_l_hid2_dr, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.GlorotUniform(gain='relu'), name='gen_1_l_hid3'))
gen_1_l_hid3_dr = lasagne.layers.DropoutLayer(gen_1_l_hid3, 0.5)
gen_1_l_out = lasagne.layers.DenseLayer(gen_1_l_hid3_dr, num_units=d, nonlinearity=None, W=lasagne.init.GlorotUniform(), name='gen_1_l_out')
...
dec_1_l_hid1 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(gen_1_l_out, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.Orthogonal(gain='relu'), name='dec_1_l_hid1'))
dec_1_l_hid2 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(dec_1_l_hid1, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.Orthogonal(gain='relu'), name='dec_1_l_hid2'))
dec_1_l_hid3 = lasagne.layers.batch_norm(lasagne.layers.DenseLayer(dec_1_l_hid2, num_units=GEN_HIDDEN_DIM, nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.Orthogonal(gain='relu'), name='dec_1_l_hid3'))
dec_1_l_out = lasagne.layers.DenseLayer(dec_1_l_hid3, num_units=d, nonlinearity=None, W=lasagne.init.Orthogonal(), name='dec_1_l_out')
